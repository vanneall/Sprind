...
class CharacteristicDelegate: Delegate<CharacteristicDescriptionViewObject> {

    override fun isSupported(view: ViewObject) = view is CharacteristicDescriptionViewObject

    override fun createViewHolder(parent: ViewGroup): ViewHolderV2<CharacteristicDescriptionViewObject> {
