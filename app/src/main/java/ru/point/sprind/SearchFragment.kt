...
class SearchFragment : Fragment() {
    ...
    val list = listOf(
        ru.point.domain.entity.Request(1, "Goodle pixel 8"),
        ru.point.domain.entity.Request(2, "Iphone 13 pro max"),
        ru.point.domain.entity.Request(3, "Logitech")
    )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbar.search.focusable = View.FOCUSABLE
        binding.toolbar.search.isFocusable = true
